...
#codigo para corregir error al asignar el puesto. Se debe corregir el firmware de la unidad central
if @partida.nadador_id_1 != nil && @partida.nadador_id_2 == nil
	@ganador = @partida.nadador_id_1
	@partida.puesto_nadador_1=1
	@partida.puesto_nadador_2=2
	@partida.save
end
  if @ganador==nil
